...
ALTER FUNCTION public.f_crelation(v_actid integer, v_rtype character varying, v_rname character varying, v_dep integer) OWNER TO postgres;
...
ALTER FUNCTION public.f_ekeyspace(v_taskid integer, v_actid integer, v_relationname character varying, v_iik integer, v_fik integer, v_relationtype character varying) OWNER TO postgres;
...
ALTER TABLE public.ekeyspace OWNER TO postgres;
...
REVOKE ALL ON TABLE ekeyspace FROM postgres;
GRANT ALL ON TABLE ekeyspace TO postgres;
